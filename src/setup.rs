...
/// BBS+ generators: `g1 ∈ G1`, `g2 ∈ G2`, and `h_0 … h_5 ∈ G1`.
///
...
impl Generators {
    ...
    fn compute() -> Self {
        ...
        let dst = b"ACT:BBS:";
        let mut h = [G1Projective::identity(); 6];
        ...
        let h_affine = [
            ...
            h_affines[3], h_affines[4], h_affines[5],
        ];
...
mod tests {
    ...
    fn generator_derivation() {
        ...
        assert_eq!(gens.h[5], hash_to_g1(b"ACT:BBS:", &5u32.to_be_bytes()));
    }
